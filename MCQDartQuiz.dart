      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 10),
            ElevatedButton(onPressed: () => QuizUtilities.checkAnswer(1, nextQuestion), child: Text(q['opa'])),
            ElevatedButton(onPressed: () => QuizUtilities.checkAnswer(2, nextQuestion), child: Text(q['opb'])),
            ElevatedButton(onPressed: () => QuizUtilities.checkAnswer(3, nextQuestion), child: Text(q['opc'])),
            ElevatedButton(onPressed: () => QuizUtilities.checkAnswer(4, nextQuestion), child: Text(q['opd'])),
            SizedBox(height: 10),
